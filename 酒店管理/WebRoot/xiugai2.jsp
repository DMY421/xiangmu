                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12"> <span class="heading-meta">Information</span>
                                <h2 class="addo-heading animate-box" data-animate-effect="fadeInLeft">请输入需要修改的用户ID：</h2> </div>
                         <form action="xiugai3.jsp" >
     <table border="1" >
     <tr><th width=200>请输入需要修改的用户名：</th><th width=720><input type="text" name="yhm"></th></tr>
       <tr><th width=200>输入修改后的联系电话：</th><th width=720><input type="text" name="lxdh"></th></tr>
        
         <tr><th width=200>输入修改后的入住人数：</th><th width=720><input type="text" name="rs"></th></tr>
...
<hr>
      ...
      <tr>
      <td width=250>客户名</td>
      <td width=750><input type ="text" name="yhm"></td>
      </tr>

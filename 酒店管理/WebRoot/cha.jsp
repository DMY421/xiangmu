...
%>
									...
									<%
String s=request.getParameter("name");//获取上一页submit传过来的name值
Statement stmt=conn.createStatement();//调用上面的conn
String strSql="select * from userInfo where username = '"+s+"'";
...
%>
									...
									<tr>
										...
										<td><%=rs.getString("lxdh")%></td>
										<td><%=rs.getString("xz")%></td>

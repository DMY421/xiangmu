...
<html>
  ...
  <body>
    ...
    String s1=Bytes(request.getParameter("username"));
  
    String s2=Bytes(request.getParameter("lxdh"));
    String s3=Bytes(request.getParameter("xz"));

    String strSql="update userInfo set username='"+s1+"',lxdh='"+s2+"',xz='"+s3+"' WHERE username = '"+s1+"'";
   ...
   // pstmt.setString(3,s3);
    ...
    if(intTemp!=0)
    {
        ...
        "window.location.href='xiugai1.jsp';</script>");
    }
    else
    {
        out.println
